...
public class OSDModule {
    ...
    public boolean setTimeTitle(int channel,  boolean bBlend, boolean bShowWeek) {
        ...
        return INetSDK.SetConfig(NetSDKApplication.getInstance().getLoginHandle(), NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_TIMETITLE, channel, timeTitle, 5000, null, null);
    }
    ...
    public boolean setChannelTitle(int channel,  boolean bBlend) {
        ...
        return INetSDK.SetConfig(NetSDKApplication.getInstance().getLoginHandle(), NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_CHANNELTITLE, channel, channelTitle, 5000, null, null);
    }
    ...
    public boolean setChannelName(int channel, String channelName) {
        ...
        return ToolKits.SetDevConfig(FinalVar.CFG_CMD_CHANNELTITLE, channelTitleName, NetSDKApplication.getInstance().getLoginHandle(), channel, 2048);
    }
