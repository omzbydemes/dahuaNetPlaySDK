...
public class MotionDetectConfigActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.motion_detect_config_toolbar);
    ...
    private void initUIView() {
        mChannelNumLayout = findViewById(R.id.motion_channel_layout);
        mChannelNumTextView = findViewById(R.id.motion_channel_text);
        mChannelNumLayout.setOnClickListener(this);

        mMotionEnableLayout = findViewById(R.id.motion_enable_layout);
        mMotionEnableBtn = findViewById(R.id.motion_enable_btn);
        mMotionEnableLayout.setOnClickListener(this);

        mTimeSectionLayout = findViewById(R.id.motion_time_layout);
        mTimeSectionLayout.setOnClickListener(this);

        mDejitterLayout = findViewById(R.id.motion_dejitter_layout);
        mDejitterTextView = findViewById(R.id.motion_dejitter_text);
        mDejitterLayout.setOnClickListener(this);

        mRregionLayout = findViewById(R.id.motion_region_layout);
        mRregionLayout.setOnClickListener(this);

        mRecordChannelLayout = findViewById(R.id.record_enable_layout);
        mRecordEnableBtn = findViewById(R.id.record_enable_btn);
        mRecordChannelLayout.setOnClickListener(this);

        mRecordDelayTimeLayout = findViewById(R.id.record_delay_layout);
        mRecordDelayTimeTextView = findViewById(R.id.record_delay_text);
        mRecordDelayTimeLayout.setOnClickListener(this);

        mAlarmOutEnableLayout = findViewById(R.id.alarmout_enable_layout);
        mAlarmOutEnableBtn = findViewById(R.id.alarmout_enable_btn);
        mAlarmOutEnableLayout.setOnClickListener(this);

        mAlarmOutDelayTimeLayout = findViewById(R.id.alarmout_delay_layout);
        mAlarmOutDelayTimeTextView = findViewById(R.id.alarmout_delay_text);
        mAlarmOutDelayTimeLayout.setOnClickListener(this);

        mSnapLayout = findViewById(R.id.snap_enable_layout);
        mSnaptBtn = findViewById(R.id.snap_enable_btn);
        ...
        for (int i = 0; i < nChn; i++) {
            items[i] = res.getString(R.string.channel) + i;
    ...
    private class GetMotionTask extends AsyncTask<String, Integer, CFG_MOTION_INFO> {
        ...
        protected void onPostExecute(CFG_MOTION_INFO motion_info) {
            ...
            if(motion_info == null) {
                ...
                // 录像延时
                mRecordDelayTimeTextView.setText(motion_info.stuEventHandler.nRecordLatch + res.getString(R.string.second));

                // 报警输出使能
                mAlarmOutEnableBtn.setSelected(motion_info.stuEventHandler.bAlarmOutEn);

                // 报警输出延时
                mAlarmOutDelayTimeTextView.setText(motion_info.stuEventHandler.nAlarmOutLatch + res.getString(R.string.second));
