...
public class ApSearchWLANListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.ap_config_toolbar);
        ...
        recyclerView = findViewById(R.id.ap_wlan_list_recyclerview);
    ...
    private class ApWlanListDateHolder extends RecyclerView.ViewHolder {
        ...
        public ApWlanListDateHolder(View view) {
            ...
            mApWlanLayout = view.findViewById(R.id.ap_wlan_layout);
            mWlanNameTextView = view.findViewById(R.id.ap_wlan_name_text);
        }
    }
    ...
    private class GetWlanListTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
             ...
             */
            return INetSDK.GetDevConfig(NetSDKApplication.getInstance().getLoginHandle(), FinalVar.SDK_DEV_WLAN_DEVICE_CFG_EX2, -1, stListEx2, stIntRet, 5000);
        }
        @Override
