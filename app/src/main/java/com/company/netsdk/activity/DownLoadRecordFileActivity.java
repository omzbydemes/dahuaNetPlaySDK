...
public class DownLoadRecordFileActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case DOWNLOAD_PROGRESS:   ///用于接收下载进度
                    mTextViewProgress.setText("(" + msg.obj + "%)");
                    break;
    ...
    private void setupView(){
        ...
        mStreamSpinner = findViewById(R.id.stream_spinner);
        ...
        mTextViewStartDate = findViewById(R.id.download_start_date);
        mTextViewStartTime = findViewById(R.id.download_start_time);
        mTextViewStartDate.setOnClickListener(this);
        mTextViewStartTime.setOnClickListener(this);

        mTextViewEndDate = findViewById(R.id.download_end_date);
        mTextViewEndTime = findViewById(R.id.download_end_time);
        ...
        mTextView = findViewById(R.id.down_textview);
        mTextViewProgress = findViewById(R.id.download_progress);
        mSeekBar = findViewById(R.id.download_seekbar);
