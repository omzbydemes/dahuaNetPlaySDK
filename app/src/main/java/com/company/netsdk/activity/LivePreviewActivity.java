...
import static com.company.netsdk.module.OSDModule.GetChannelInfoListener;
import static com.company.netsdk.module.OSDModule.GetTimeTitleInfoListener;
import static com.company.netsdk.module.OSDModule.SetChannelInfoListener;
import static com.company.netsdk.module.OSDModule.SetTimeTitleInfoListener;
...
public class LivePreviewActivity extends AppCompatActivity implements
    ...
    private void setupView(){
        mSelectStream = findViewById(R.id.select_stream_type);
        mSelectChannel = findViewById(R.id.select_channel);
        ...
        findViewById(R.id.preview_ptz_control).setOnClickListener(this);
        mPtzControlLayoutView = findViewById(R.id.ptz_control);
        mEditText = mPtzControlLayoutView.findViewById(R.id.edittext_preset);
        ...
        mPtzControlLayoutView.findViewById(R.id.preview_focus_add).setOnClickListener(this);
        mPtzControlLayoutView.findViewById(R.id.preview_focus_dec).setOnClickListener(this);
        mPtzControlLayoutView.findViewById(R.id.preview_aperture_add).setOnClickListener(this);
        mPtzControlLayoutView.findViewById(R.id.preview_aperture_dec).setOnClickListener(this);
        mPtzControlLayoutView.findViewById(R.id.preview_setpreset).setOnClickListener(this);
        mPtzControlLayoutView.findViewById(R.id.preview_clearpreset).setOnClickListener(this);
        mPtzControlLayoutView.findViewById(R.id.preview_gotopreset).setOnClickListener(this);

        btnStartPlay = findViewById(R.id.buttonStartPlay);
        btnStartPlay.setOnClickListener(this);
        findViewById(R.id.buttonLocalCapture).setOnClickListener(this);
        mEncodeBtn = findViewById(R.id.preview_encode);
        mEncodeBtn.setOnClickListener(this);
        findViewById(R.id.buttonStartRecord).setOnClickListener(this);

        btnChannelTitle = findViewById(R.id.preview_osd_channel);
        btnChannelTitle.setOnClickListener(this);

        btnTimeTitle = findViewById(R.id.preview_osd_time);
            ...
            case R.id.preview_osd_channel: // osd 通道标题
            {
                ...
                osdModule.addGetChannelInfoListener(new GetChannelInfoListener() {
                    ...
                    public void onChannelInfoListener(boolean bRet1, boolean bRet2, boolean bEncodeBlend, String channelName) {
                        ...
                        // 通道标题使能
                        RelativeLayout channelTitleEnableLayout = channelView.findViewById(R.id.channel_title_enable_layout);
                        final ImageView channelTitleEnableImageView = channelView.findViewById(R.id.channel_title_enable_btn);

                        // 通道标题名称
                        final EditText channelTitleNameEd = channelView.findViewById(R.id.channel_title_name_text);

                        // 通道标题按钮
                        Button setChannelTitleBtn = channelView.findViewById(R.id.set_channel_title_btn);
            ...
            case R.id.preview_osd_time: // osd 时间标题
            {
                ...
                osdModule.addGetTimeTitleInfoListener(new GetTimeTitleInfoListener() {
                    ...
                    public void onTimeTitleInfoListener(boolean bRet, boolean bBlend, boolean bShowWeek) {
                        ...
                        // 时间标题使能
                        RelativeLayout timeTitleEnableLayout = timeView.findViewById(R.id.time_title_enable_layout);
                        final ImageView timeTitleEnableImageView = timeView.findViewById(R.id.time_title_enable_btn);

                        // 显示星期使能
                        RelativeLayout weekeEnableLayout = timeView.findViewById(R.id.show_week_enable_layout);
                        final ImageView weekEnableImageView = timeView.findViewById(R.id.show_week_enable_btn);

                        // 时间标题按钮
                        Button setTimeTitleBtn = timeView.findViewById(R.id.set_time_title_btn);
...
//    }
    ...
    private void onEncode(){
        ...
        mEncodeSetBtn = mEncodeLayoutView.findViewById(R.id.encode_set_btn);
        mEncodeLayoutView.findViewById(R.id.encode_set_layout).setOnClickListener(this);
        mEncodeLayoutView.findViewById(R.id.resolution_set_layout).setOnClickListener(this);
        mEncodeLayoutView.findViewById(R.id.frame_rate_set_layout).setOnClickListener(this);
        mEncodeLayoutView.findViewById(R.id.bit_rate_set_layout).setOnClickListener(this);
        mEncodeLayoutView.findViewById(R.id.audio_encode_mode_set_layout).setOnClickListener(this);
        mEncodeLayoutView.findViewById(R.id.audio_rate_set_layout).setOnClickListener(this);

        mEncodeMode = mEncodeLayoutView.findViewById(R.id.encode_set_text);
        mEncodeResolution  = mEncodeLayoutView.findViewById(R.id.resolution_set_text);
        mEncodeFrameRate  = mEncodeLayoutView.findViewById(R.id.frame_rate_set_text);
        mEncodeBitRate  = mEncodeLayoutView.findViewById(R.id.bit_rate_set_text);
        mAudioEncodeMode  = mEncodeLayoutView.findViewById(R.id.audio_encode_mode_set_text);
        mAudioRate  = mEncodeLayoutView.findViewById(R.id.audio_rate_set_text);
    ...
    private boolean isMainStream(){
       return mSelectStream.getSelectedItemPosition() == 0;
    }
