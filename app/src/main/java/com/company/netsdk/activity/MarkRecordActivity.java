...
public class MarkRecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setupView() {
        mChnSpinner = findViewById(R.id.channel_spinner);
        ...
        mTextViewStartDate = findViewById(R.id.mark_record_start_date);
        mTextViewStartTime = findViewById(R.id.mark_record_start_time);
        mTextViewStartDate.setOnClickListener(this);
        mTextViewStartTime.setOnClickListener(this);

        mTextViewEndDate = findViewById(R.id.mark_record_end_date);
        mTextViewEndTime = findViewById(R.id.mark_record_end_time);
        ...
        mDatePicker = mLayoutView.findViewById(R.id.date_set_picker);
        mTimePicker = mLayoutView.findViewById(R.id.time_set_picker);
        mTimePicker.setIs24HourView(true);

        findViewById(R.id.lock_record_button).setOnClickListener(this);
        findViewById(R.id.query_record_button).setOnClickListener(this);
        findViewById(R.id.unlock_record_button).setOnClickListener(this);

        mMarkFileCountText = findViewById(R.id.mark_file_count);
        recyclerView = findViewById(R.id.mark_file_recycle);
                ...
                .setPositiveButton(getString(R.string.confirm), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (markId == MARK_START_DATE_TIME) {
                            ...
                            mTextViewStartDate.setText(selectTime.dwYear + "-" + monthStr + "-" + dayStr);
                            mTextViewStartTime.setText(hourStr + ":" + minuteStr);
                        } else {
                            copyTime(markEndTime, selectTime);
                            mTextViewEndDate.setText(selectTime.dwYear + "-" + monthStr + "-" + dayStr);
    ...
    public class MarkFileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public class ListItemViewHolder extends RecyclerView.ViewHolder {
            ...
            ListItemViewHolder(View view) {
                super(view);
                this.info = view.findViewById(R.id.mark_file_info);
