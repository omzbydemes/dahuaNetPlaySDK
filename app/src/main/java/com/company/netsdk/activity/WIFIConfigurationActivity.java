...
public class WIFIConfigurationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void setupView(){
        ...
        mSsidEditText = findViewById(R.id.ssid_et);
        mPwdEditText = findViewById(R.id.pwd_et);
        ...
        findViewById(R.id.config_start).setOnClickListener(this);

        mDeviceInfoTextView = findViewById(R.id.config_device_info);
    }
