...
public class LivePreviewDoubleChannelActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void setupView(){
        mView1 = findViewById(R.id.multiply_view_1);
        mView2 = findViewById(R.id.multiply_view_2);

        mSelectStream1 = findViewById(R.id.select_stream_type_1);
        mSelectChannel1 = findViewById(R.id.select_channel_1);

        mSelectStream2 = findViewById(R.id.select_stream_type_2);
        mSelectChannel2 = findViewById(R.id.select_channel_2);
        ...
        findViewById(R.id.buttonStartReplay1).setOnClickListener(this);
        btnStartReplay2 = findViewById(R.id.buttonStartReplay2);
