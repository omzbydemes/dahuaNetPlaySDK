...
public class P2PLoginActivity extends AppCompatActivity {
    ...
    private void setupView() {
        mEditTextServerIp = findViewById(R.id.editTextP2pServerIp);
        mEditTextServerPort = findViewById(R.id.editTextP2pServerPort);
        mEditTextP2pUsername = findViewById(R.id.editTextP2pUsername);
        mEditTextP2pPassword = findViewById(R.id.editTextP2pPassword);
        mEditTextP2pDeviceId = findViewById(R.id.editTextP2pDeviceId);
        mEditTextP2pDevicePort = findViewById(R.id.editTextP2pDevicePort);
        mEditTextP2pDeviceUsername = findViewById(R.id.editTextP2pDeviceUsername);
        mEditTextP2pDevicePassword = findViewById(R.id.editTextP2pDeivcePassword);
        mCheckBoxP2p = findViewById(R.id.checkBoxP2p);

        mButtonLogin = findViewById(R.id.buttonP2pLogin);
        ...
        scanButton = findViewById(R.id.scan_button_p2p);
        ...
        mP2PEyeImageButton = findViewById(R.id.eye_p2p_pwd_button_p2p);
        mDeviceEyeImageButton = findViewById(R.id.eye_device_pwd_button_p2p);
