...
public class TalkActivity extends AppCompatActivity implements
    ...
    private void setupView(){
        mSelectTransferChn = findViewById(R.id.spinner_transfer_channel);
        mSelectTransferMode = findViewById(R.id.spinner_transfer_mode);
        ...
        mStartBtn = findViewById(R.id.buttonStartTalk);
