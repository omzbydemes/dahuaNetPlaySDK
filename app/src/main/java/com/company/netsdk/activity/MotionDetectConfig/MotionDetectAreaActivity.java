...
public class MotionDetectAreaActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.motion_detect_area_toolbar);
    ...
    private void initUIView() {
        mSenseLevelLayout = findViewById(R.id.motion_sense_level_layout);
        mSenseLevelTextView = findViewById(R.id.motion_sense_level_text);
        ...
        mThresholdLayout = findViewById(R.id.motion_threshold_layout);
        mThresholdTextView = findViewById(R.id.motion_threshold_text);
        ...
        mAreaEditImageView = findViewById(R.id.motion_detect_area_edit);
        mAreaDeleteImageView = findViewById(R.id.motion_detect_area_delete);
