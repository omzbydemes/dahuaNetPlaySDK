...
public class MotionDetectTimeSetActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.motion_detect_time_toolbar);
    ...
    private void initUIView() {
        ...
        detectDateLayout = findViewById(R.id.motion_detect_date_layout);
        detectDateTextView = findViewById(R.id.motion_detect_date_text);
        detectDateTextView.setText(dates[mIndex]);

        recyclerView = findViewById(R.id.motion_detect_date_recycle);
    ...
    private class MotionDetectDateHolder extends RecyclerView.ViewHolder {
        ...
        public MotionDetectDateHolder(View view) {
            ...
            mEnableImageView = view.findViewById(R.id.detect_time_enable);
            mIndexTextView = view.findViewById(R.id.detect_time_index);
            mDetectTimeTextView = view.findViewById(R.id.detect_time_text_set);
        }
    }
        ...
        public void onBindViewHolder(final MotionDetectDateHolder holder, final int position) {
            ...
            holder.mDetectTimeTextView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startTimePicker = view.findViewById(R.id.motion_start_time_picker);
                    endTimePicker = view.findViewById(R.id.motion_end_time_picker);
