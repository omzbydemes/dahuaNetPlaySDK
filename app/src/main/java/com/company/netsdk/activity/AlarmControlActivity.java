...
public class AlarmControlActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener{
    ...
    private void setupView(){
        mSelectAlarmInputChn = findViewById(R.id.spinner_alarm_input_channel);
        mSelectAlarmInputState = findViewById(R.id.spinner_alarm_input_state);
        mSelectAlarmOutputChn = findViewById(R.id.spinner_alarm_output_channel);
        mSelectAlarmOutputState = findViewById(R.id.spinner_alarm_output_state);
        mSelectAlarmTriggerChn = findViewById(R.id.spinner_alarm_trigger_channel);
        mSelectAlarmTriggerMode = findViewById(R.id.spinner_alarm_trigger_mode);

        findViewById(R.id.inputgetbutton).setOnClickListener(this);
        findViewById(R.id.inputsetbutton).setOnClickListener(this);
        findViewById(R.id.outputgetbutton).setOnClickListener(this);
        findViewById(R.id.outputsetbutton).setOnClickListener(this);
        findViewById(R.id.triggergetbutton).setOnClickListener(this);
        findViewById(R.id.triggersetbutton).setOnClickListener(this);
    }
