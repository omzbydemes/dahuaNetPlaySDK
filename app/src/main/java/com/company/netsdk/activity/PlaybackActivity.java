...
public class PlaybackActivity extends AppCompatActivity
    ...
    private void setupView() {
        ...
        mSelectStreamType = findViewById(R.id.select_stream_type);
        ...
        mSurface = findViewById(R.id.play_back_view);
        mPlayBackModule.setView(mSurface);

        mPlayBackSeekbar = findViewById(R.id.play_back_seekbar);
        mPlayBackSeekbar.setProgress(0);
        mPlayBackSeekbar.setOnSeekBarChangeListener(new PlayBackProgress());
        mCurrentOSDTime = findViewById(R.id.current_osd_time);

        mPlayButton = findViewById(R.id.play_start_pause);
        mFastPlayButton = findViewById(R.id.play_fast);
        mSlowPlayButton = findViewById(R.id.play_slow);
        mNormalPlayButton = findViewById(R.id.play_normal);
        ...
        mSelectFileType = findViewById(R.id.select_recordfile_type);
        initializeSpinner(mSelectFileType, (ArrayList) mPlayBackModule.getRecordFileTypeList()).setSelection(0);

        mPlayBackButton = findViewById(R.id.start_playback);
        mPlayBackButton.setOnClickListener(this);
        mLocalCaptureButton = findViewById(R.id.local_capture_picture);
        mLocalCaptureButton.setOnClickListener(this);
        findViewById(R.id.mark_record).setOnClickListener(this);
        findViewById(R.id.download_record).setOnClickListener(this);
    ...
    public void onDateTimeChangeed(int id, int year, int month, int day) {
        switch (id){
            case R.id.playback_date:
                ...
                mPlayBackTimeTv.setText(year +"-"+ month +"-"+
                        day);
                break;
            default:
                break;
